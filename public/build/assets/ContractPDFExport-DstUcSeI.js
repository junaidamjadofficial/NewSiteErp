const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-Dais6JZR.js","./vendor-CcMVubkO.js","./app-BBiA4mAE.js","./ui-ZHFf5B17.js","./app-CQG9E_-B.css","./app-pTHChVWB.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-BBiA4mAE.js";import{j as i}from"./ui-ZHFf5B17.js";import{B as x}from"./button-DYC7yMVq.js";import{a as f,b,c as h}from"./tooltip-C7wT1CW2.js";import{f as v,a as n,k as p}from"./helpers-QYnGjXad.js";import{u as _}from"./useTranslation-CV4_gBnb.js";import{D as y}from"./download-DpWzK9fg.js";/* empty css            */import"./vendor-CcMVubkO.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-DrcJ8Itn.js";import"./index-BZAHB8Ku.js";import"./createLucideIcon-Dov4NOxw.js";function A({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var r;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-Dais6JZR.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{A as default};
